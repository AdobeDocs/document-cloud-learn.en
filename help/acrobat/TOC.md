...
+ Use cases {#use-cases}
  ...
  + Line of business {#lob}
    ...
    + Marketing {#marketing}
      + [Overview](use-cases/lob/marketing/marketing-overview.md)
...
+ Mobile {#mobile}
  ...
  + [Productivity on the go](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/get-started/basics/productivity)
