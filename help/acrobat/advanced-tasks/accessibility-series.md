...
<tr>
  <td>
    ...
    <em>In this on-demand session, learn what it means to make a PDF accessible, how to set up Acrobat Pro (Premium or Studio) to work on PDFs for accessibility, and the conversion process from a source document to a PDF</em>
    <br>
  </td>
  <td>
    ...
    <em>In this on-demand session, learn the workflow to convert a Word document and fixing some basic tagging issues using the Acrobat Pro (Premium or Studio) tools shown in the introduction webinar</em>
    <br>
  </td>  
  <td>
