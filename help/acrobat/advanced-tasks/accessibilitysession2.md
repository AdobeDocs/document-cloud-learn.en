...
In this on-demand session, learn the workflow to convert a Word document and fixing some basic tagging issues using the Acrobat Pro (Premium or Studio) tools shown in the introduction webinar.
