...
Delivering the best customer experiences requires content to be created faster than ever before. Learn how to use guided actions to run one or more commands across numerous documents with a single click—saving you time and keystrokes. This video tutorial uses the [new workspace experience](../getting-started/new-workspace.mdnew-workspace.md).
