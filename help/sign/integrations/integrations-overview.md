  ...
  <td>
   ...
   <td>
    <a href="acrobat-sign-teams-documents-tab.md">
      <img alt="Documents tab integration for [!DNL Microsoft Teams]" src="../assets/Documents-tab.png" />
    </a>
    <div>
    <a href="acrobat-sign-teams-documents-tab.md"><strong>Documents tab integration for [!DNL Microsoft Teams]</strong></a>
    </div>
    <em>Learn how to send documents out for signature directly from the Documents tab in [!DNL Microsoft Teams]</em>
    <br>
  </td>
 <td>
    ...
    <div>
    <a href="simple-workflow-power-automate.md"><strong>Create a simple workflow with [!DNL Power Automate]</strong></a>
    </div>
    <em>Learn how to create a simple workflow using [!DNL Power Automate] connectors</em>
    <br>
  </td>
  <td>
    <a href="advanced-workflow-power-automate.md">
      <img alt="Create an advanced workflow with Power Automate" src="../assets/advanced-workflow.png" />
    </a>
    <div>
    <a href="advanced-workflow-power-automate.md"><strong>Create an advanced workflow with Power Automate</strong></a>
    </div>
    <em>Learn how to create an advanced workflow using [!DNL Power Automate] connectors</em>
    <br>
  </td>
<tr>
  <td>
...
<tr>
 ...
 <td>
    <a href="salesforce-large-files.md">
      <img alt="Set up large files and push mappings" src="../assets/large-files.png" />
    </a>
    <div>
    <a href="salesforce-large-files.md"><strong>Set up large files and push mappings</strong></a>
    </div>
    <em>Learn how to set up large documents and push agreement services in Salesforce</em>
    <br>
  </td>
  <td>
      <img alt="Spacer" src="../assets/Grayspacer.png" />
